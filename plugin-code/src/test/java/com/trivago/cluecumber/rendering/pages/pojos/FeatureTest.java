...
public class FeatureTest {
    ...
    public void equalsSameNameTest() {
        final Feature featureToCompare = new Feature("myFeature","", 2);
        assertThat(feature.equals(featureToCompare), is(false));
    }

    @Test
    public void equalsSameIndexTest() {
        final Feature featureToCompare = new Feature("otherName","", 1);
        assertThat(feature.equals(featureToCompare), is(false));
    }
    ...
    public void equalsSameNameAndIndexTest() {
        final Feature featureToCompare = new Feature("myFeature","", 1);
