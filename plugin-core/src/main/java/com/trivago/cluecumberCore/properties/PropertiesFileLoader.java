...
package com.trivago.cluecumberCore.properties;
...
public class PropertiesFileLoader {
    ...
    public LinkedHashMap<String, String> loadPropertiesMap(final String propertiesFilePath) throws CluecumberPluginException {
